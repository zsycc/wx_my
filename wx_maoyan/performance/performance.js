...
Page({
  ...
  data: {
    ...
    imgUrls: [
      '../../image/20171120021153576.jpg',
      '../../image/679754585982620329.jpg',
      '../../image/banner1.jpg'
    ]
  },
  ...
  onLoad: function (options) {
    qqmapsdk = new QQMapWX({
      key: 'UD4BZ-7MAC6-FY4SR-EMP54-Q4HOE-ZRFVM'
    });
    wx.authorize({
  ...
  onReachBottom: function () {
    var json = this.data.json.data.concat(this.data.jsons.data)
    this.setData({
      ['json.data']: json
    })
  },
